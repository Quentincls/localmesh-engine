...
# 3.3 : un proprietaire par quad aux frontieres des tuiles (voir owned_tiled_mesh).
from localmesh_engine.owned_tiled_mesh import tiled_flexible_dual_grid_to_mesh
